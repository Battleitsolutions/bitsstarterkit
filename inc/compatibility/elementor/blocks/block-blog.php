 ...
 * @since 1.0.0
 */
class bits_Blog extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'categories',
			[
				'label' => __( 'Select your categories', 'bits' ),
		...
		$this->add_control(
			'date_bg_color',
			[
				'label' => __( 'Background color', 'bits' ),
				...
				'condition' => [
					'_skin' => 'bits_athemes_blog_skin_4',
				],					
			]
		);		
					...
					<div class="col-md-4 col-sm-6">
						<div class="post-item">
							<?php if ( has_post_thumbnail() ) : ?>
								<?php the_post_thumbnail( 'bits-360-360' ); ?>
							<?php endif; ?>					
							<div class="post-content">	
								<?php bits_posted_on(); ?>
								<?php the_title( '<h3 class="entry-title"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h3>' ); ?>
								<?php bits_first_category(); ?>
								<?php bits_posted_by(); ?>
							</div>	
						</div>				
					</div>
...
Plugin::instance()->widgets_manager->register_widget_type( new bits_Blog() );