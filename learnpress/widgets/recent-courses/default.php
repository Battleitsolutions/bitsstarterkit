...
<div class="archive-course-widget-outer bits-course <?php esc_attr( $instance["css_class"] ); ?>">
                ...
                <div class="course-entry-inner">
                    ...
                    <div class="course-detail">
                        ...
                        <?php if ( ! empty( $instance['show_teacher'] ) ) { ?>
                            <div class="course-meta-field course-instructor"><?php echo esc_html( 'By', 'bits' ); ?>&nbsp;<?php echo $course->get_instructor_html(); ?></div>
                        <?php } ?>
                        ...
                        <div class="course-meta-data">                           
                            ...
                            <?php if ( ! empty( $instance['show_lesson'] ) ) { ?>
                                <div class="course-lesson-number course-meta-field">
                                    ...
                                    echo $lesson_count > 1 ? sprintf( __( '%d lessons', 'bits' ), $lesson_count ) : sprintf( __( '%d lesson', 'bits' ), $lesson_count ); ?>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
